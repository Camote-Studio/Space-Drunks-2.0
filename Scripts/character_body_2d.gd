...
@export var ulti_drain_rate := 20.0
...
func apply_damage(amount: float, source: String = "desconocido") -> void:
	_on_damage(amount, source)
...
func _throw_bomb() -> void:
	...
	bomb.target_y = global_position.y + 10.0
